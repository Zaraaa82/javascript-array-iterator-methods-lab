...
let sortedByBirthYear = inventors.sort((inventor1,inventor2) => inventor1.year -inventor2.year)
...
let isAdultPresent = devs.some(dev => 2026-dev.year >= 18)
...
let isEveryone19OrOlder = devs.every(dev => 2026-dev.year > 18)
...
let totalYearsLived = inventors.reduce((sum,inventor) => sum + (inventor.passed - inventor.year) , 0);
...
// Note: counts is an object that stores travel methods as keys and their counts as values.
//       It is updated during each reduce() iteration.
